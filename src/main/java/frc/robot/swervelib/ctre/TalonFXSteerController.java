...
import frc.robot.swervelib.ContinuousAngle;
import frc.robot.swervelib.DiscreetAngle;
import frc.robot.swervelib.GearRatio;
import frc.robot.swervelib.SteerController;
...
public final class TalonFXSteerController implements SteerController {
    ...
    public TalonFXSteerController(int motorCanId, Falcon500SteerConfiguration steerConfiguration, GearRatio gearRatio, AbsoluteEncoder absoluteEncoder) {

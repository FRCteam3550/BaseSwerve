...
public class Falcon500Drivetrain extends SubsystemBase {
    ...
    public Falcon500Drivetrain(CommandXboxController gamepad) {
    ...
    private void setModuleTelemetry(ModuleLocation module) {
        ...
        layout.addDouble("Drive position native", () -> swerveDrive.getDrivePositionNativeUnits(module));

...
public class HolonomicSpeedSetPoint {
     ...
     */
    public HolonomicSpeedSetPoint(double xSpeed, double ySpeed, double rotationSpeed) {
        this.xSpeed = xSpeed;
        this.ySpeed = ySpeed;
    ...
    public boolean equals(Object obj) {
        ...
        HolonomicSpeedSetPoint other = (HolonomicSpeedSetPoint) obj;

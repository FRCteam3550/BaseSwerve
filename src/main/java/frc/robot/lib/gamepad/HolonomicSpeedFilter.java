...
public class HolonomicSpeedFilter implements Sendable {
     ...
     */
    public HolonomicSpeedFilter withDeadband(double deadbandPct) {
        return new HolonomicSpeedFilter(
            deadbandPct,
            m_fastModeLimitPct,
     ...
     */
    public HolonomicSpeedFilter withRangeLimits(double fastModeLimitPct, double preciseModeLimitPct) {
        return new HolonomicSpeedFilter(
            m_deadbandPct,
            fastModeLimitPct,
            preciseModeLimitPct,
     ...
     */
    public HolonomicSpeedFilter withTranslationInputSpeedLimit(double translationInputSpeedLimitPctPerS) {
        return new HolonomicSpeedFilter(
            m_deadbandPct,
            m_fastModeLimitPct,
            m_preciseModeLimitPct,
     ...
     * @param rotationConversionRatio the multiplicative ratio to apply if we want to apply a unit conversion to the percent input.
     */
    public HolonomicSpeedFilter withConversionRatios(double translationConversionRatio, double rotationConversionRatio) {
        return new HolonomicSpeedFilter(
            m_deadbandPct,
            m_fastModeLimitPct,
            m_preciseModeLimitPct,
     ...
     */
    public HolonomicSpeedSetPoint filter(HolonomicSpeedSetPoint inputsPct) {
        ...
        return new HolonomicSpeedSetPoint(
